...
# 2. Test area calculation
def test_rectangle_area():

    r = Rectangle(width=2, height=4)
    assert r.area == 8

# 3. Test perimeter calculation
def test_rectangle_perimeter():

    r = Rectangle(width=2, height=4)
    assert r.perimeter == 12

# 4. Test if rectangle is square
def test_is_square():
